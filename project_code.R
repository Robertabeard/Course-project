...
Core_Data <- read_csv(File = "C:/Users/jmdre/Documents/BOT 4530/Project/Random Code/CombinedCoreData.csv")
...
merged_metals_amf <- merge(cultivated_log10_As_Cd_Ni, cultivated_AMF, by = "species" , all = TRUE)
...
merged_metals_amf_metaldropped <- merge(merged_metals_amf, wild_metal_dropped, by = "species" , all = TRUE)
